...
(function () {
	...
	JSONfn.stringify = function(obj, replacer, space) {
		return JSON.stringify(obj,function(key, value){
				return (typeof value === 'function' ) ? value.toString() : (typeof replacer === 'function') ? replacer(value) : value;
			}, space);
	};
	...
	JSONfn.parse = function(str) {
		return JSON.parse(str,function(key, value){
			...
			return ( value.substring(0,8) == 'function') ? new Function(value.substring(value.indexOf('{'))) : value;
		});
	};
